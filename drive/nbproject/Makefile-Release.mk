...
# Test Files
TESTFILES= \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/drive
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/drive: ${TESTDIR}/tests/newsimpletest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/drive $^ ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/DrivingController_nomain.o: ${OBJECTDIR}/DrivingController.o DrivingController.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DrivingController_nomain.o DrivingController.cpp;\
	else  \
...
${OBJECTDIR}/RightWheel_nomain.o: ${OBJECTDIR}/RightWheel.o RightWheel.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/RightWheel_nomain.o RightWheel.cpp;\
	else  \
...
${OBJECTDIR}/drive_nomain.o: ${OBJECTDIR}/drive.o drive.pde 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/drive_nomain.o drive.pde;\
	else  \
...
${OBJECTDIR}/LeftWheel_nomain.o: ${OBJECTDIR}/LeftWheel.o LeftWheel.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/LeftWheel_nomain.o LeftWheel.cpp;\
	else  \
...
${OBJECTDIR}/fix_fft_nomain.o: ${OBJECTDIR}/fix_fft.o fix_fft.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/fix_fft_nomain.o fix_fft.cpp;\
	else  \
...
${OBJECTDIR}/Sensor_nomain.o: ${OBJECTDIR}/Sensor.o Sensor.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sensor_nomain.o Sensor.cpp;\
	else  \
...
${OBJECTDIR}/DirectionSensor_nomain.o: ${OBJECTDIR}/DirectionSensor.o DirectionSensor.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DirectionSensor_nomain.o DirectionSensor.cpp;\
	else  \
...
${OBJECTDIR}/Timer_nomain.o: ${OBJECTDIR}/Timer.o Timer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Timer_nomain.o Timer.cpp;\
	else  \
...
${OBJECTDIR}/WrappingArray_nomain.o: ${OBJECTDIR}/WrappingArray.o WrappingArray.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/WrappingArray_nomain.o WrappingArray.cpp;\
	else  \
...
${OBJECTDIR}/WrappingArrayIterator_nomain.o: ${OBJECTDIR}/WrappingArrayIterator.o WrappingArrayIterator.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/WrappingArrayIterator_nomain.o WrappingArrayIterator.cpp;\
	else  \
...
.test-conf:
	@if [ "${TEST}" = "" ]; \
	then  \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/drive || true; \
	else  \
	    ./${TEST} || true; \
	fi
